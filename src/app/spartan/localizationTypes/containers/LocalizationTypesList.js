...
const apiName = 'localization'

export default class LocalizationTypesList extends Component {
    constructor(props) {
        super(props);
    ...
    cellButton(cell, row, enumObject, rowIndex) {
        return (
            <div>
                ...
                <Link to = {`/localization-types/update/${row.id}`} className='btn btn-warning' >
    ...
    onClickJobTitleEdit(cell, row, rowIndex) {
        browserHistory.push('/#/localization-types/update');
    }
    ...
    localizationDelete() {
        ...
        axios.delete(`${apiName}/${values.id}`, values)
            ...
            .catch(e => { e.response.data.errors.forEach(element => console.log(element)) });
    }
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-footer">                                
                                <button type="button" className="btn btn-primary"
                                    onClick={() => this.localizationDelete()}
                                    data-dismiss="modal">
                                    Sim
                                </button>
