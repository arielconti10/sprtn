...
class RoleList extends Component {
    ...
    checkPermission() {
        canUser('role.update', this.props.history, "change", function(rules){
            if (rules.length == 0) {
    ...
    checkDeletePermission() {
        canUser('role.delete', this.props.history, "change", function(rules){
            if (rules.length == 0) {
    ...
    componentWillMount() {
        ...
        this.setState({ table_columns, initial_columns : table_columns }, function() {
            const table_preference = verifyPreferences(this.state.table_columns, 'prefs_role');
    ...
    handleChange(e) {
        ...
        savePreferences("prefs_role", columns_filter);
